...
namespace Psychology
{
    class LordJob_Joinable_Funeral: LordJob_VoluntarilyJoinable
    {
        ...
        public override StateGraph CreateGraph()
        {
            ...
            transition.AddTrigger(new Trigger_TickCondition(() => !GatheringsUtility.AcceptableGameConditionsToContinueGathering(base.Map)));
        ...
        private void Finished()
        {
            ...
            Find.LetterStack.ReceiveLetter("LetterLabelFuneralEnded".Translate(dead), "LetterFuneralEnded".Translate(dead, attendedString), LetterDefOf.NeutralEvent, null, 0, true);
            // ReceiveLetter(TaggedString label, TaggedString text, LetterDef textLetterDef, LookTargets lookTargets, Faction relatedFaction = null, Quest quest = null, List<ThingDef> hyperlinkThingDefs = null, string debugInfo = null, int delayTicks = 0, bool playSound = true)
        }
